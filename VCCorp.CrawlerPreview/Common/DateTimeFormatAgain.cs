...
namespace VCCorp.CrawlerPreview.Common
{
    internal class DateTimeFormatAgain
    {
        ...
        public string GetDateBySearchText(string sDate, string ruleDate)
        {
            try
            {
                ...
                if (isMinute == true)
                {
                    string minute = Utilities.Regex_GetItemFirst(sDate, @"([\d]{1,2} phút trước)|([\d]{1,2} minutes ago)|(cách đây [\d]{1,2} phút)");
                ...
                if (isHour == true)
                {
                    string hour = Utilities.Regex_GetItemFirst(sDate, @"([\d]{1,2} tiếng trước)|([\d]{1,2} giờ trước)|([\d]{1,2} hours trước)|([\d]{1,2} hours ago)|(cách đây [\d]{1,2} giờ)");
